...
public class Intake extends Subsystem {
    ...
    private boolean oldArmSystem = false;
    
    public double intakeSpeed = .35;
    public double lowOutputSpeed = .4;
    public double highOutputSpeed = 1;
...
//    	SmartDashboard.putData("intake", this);
    ...
    public void spinMotorsOut(double output){
    	if (oldArmSystem) leftTalon.set(-output);
