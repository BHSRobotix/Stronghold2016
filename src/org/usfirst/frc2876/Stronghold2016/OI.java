...
public class OI {
    ...
    public OI() {
        ...
        bButton.whenPressed(new IntakeIdle());
        ...
        SmartDashboard.putData("ArmToTop", new ArmToTop());
        ...
        SmartDashboard.putData("AutoCGCrossRoughTerrain", new AutoCGCrossRoughTerrain());
        SmartDashboard.putData("DriveCrossDefense: distance", new DriveCrossDefense(0, 0));
        SmartDashboard.putData("DriveCrossDefense: speed", new DriveCrossDefense(0, 0));
        SmartDashboard.putData("ArmToBottom", new ArmToBottom());
        SmartDashboard.putData("AutoCGCrossLowBar", new AutoCGCrossLowBar());
        SmartDashboard.putData("AutoCGScore", new AutoCGScore());
        SmartDashboard.putData("DriveUpRamp: speed", new DriveUpRamp(.5));

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        
        leftBumper.whenReleased(new ArmIdle());
        rightBumper.whenReleased(new ArmIdle());
