...
public class OI {
    ...
    public OI() {
        ...
        bButton.whenPressed(new ToggleSensitivity());
        ...
        SmartDashboard.putData("ControlArm", new ControlArm());
        SmartDashboard.putData("BallIntake", new BallIntake());
        SmartDashboard.putData("ShootBall", new ShootBall());
        SmartDashboard.putData("ArcadeDrive", new ArcadeDrive());
        SmartDashboard.putData("TankDrive", new TankDrive());
        SmartDashboard.putData("ToggleTankAndArcade", new ToggleTankAndArcade());
